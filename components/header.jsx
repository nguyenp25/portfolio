    ...
    return (
        <>
            <div className="topHeader">
                <div className={`wrapper ${hamBurger ? "active" : ""} `}>
                    <div className="leftHeader">
                        <a href="#home" className={`initials ${hamBurger ? "active" : "inactive"} `}><div>PN</div></a>
                        <div className={`itemContainer git ${hamBurger ? "active" : "inactive"} `}>
                        ...
                        <div className={`itemContainer linkedIn ${hamBurger ? "active" : "inactive"} `}>
                    ...
                    <div className={`offScreenMenu  ${hamBurger ? "active" : "inactive"}`}>
                        {/* ${hamBurger ? "active" : "inactive"} */}
                        <ul>
                            <a onClick={activeHamBurger} href="#home"><li>Home</li></a>
                            <a onClick={activeHamBurger} href="#portfolio"><li>Portfolio</li></a>
                            <a onClick={activeHamBurger} href="#about"><li>About Me</li></a>
                            <li>Contact</li>
                        </ul>
                    </div>
                    <nav className={`${hamBurger ? "active" : "inactive"} `}>
                        <div onClick={activeHamBurger} className="hamBurger">
                            <span className={`lineOne ${hamBurger ? "active" : "inactive"} `}></span>
                            <span className={`lineTwo ${hamBurger ? "active" : ""} `}></span>
                            <span className={`lineThree ${hamBurger ? "active" : "inactive"} `}></span>
                        </div>
                    </nav>
                </div>
            </div>
